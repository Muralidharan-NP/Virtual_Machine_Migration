  ...
  <head>
    ...
    <link href="NewCss/css/animate.css" rel="stylesheet">
      ...
      <body id="top">
        ...
        ResultSet rss = stmt.executeQuery("select * from vm");
        while(rss.next())
                       {
            String ss = rss.getString("Status");
            
                   %>
                   <tr>
                       <td><%=rss.getString("id")%></td>
                       <td><%=rss.getString("VM")%></td> 
                       
                       <td bgcolor="#FFFF00"><%=rss.getString("Status")%></td> 
                       <td><a href="active.jsp?a=<%=rss.getString("id")%>">Active</a></td>
                       <td><a href="disable.jsp?a=<%=rss.getString("id")%>">Disable</a></td>
                   </tr>
                   <% 
}                     
%>
