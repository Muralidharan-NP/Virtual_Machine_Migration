    ...
    <div class="fixed-header">
        <div class="container">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="#">VM Migration</a>
            </div>
            <nav class="main-menu">
                <ul>
...
<!--                    <li><a class="external" href="" target="_blank">External</a></li>-->
    ...
    <div class="container">
        <section class="col-md-12 content" id="home">
           <div class="col-lg-6 col-md-6 content-item">
               <img src="images/i_7da96c93.jpg" alt="Image" class="tm-image">
           </div>
           <div class="col-lg-6 col-md-6 content-item content-item-1 background">
               <h2 class="main-title text-center dark-blue-text">Virtual Machine Migration Techniques for Optimizing Energy Consumption in Cloud Data Centers
</h2>
   ...
   <section class="col-md-12 content" id="contact">
       ...
       <div class="col-lg-6 col-md-6 col-md-pull-6 content-item background flexbox">
           ...
           <p class="margin-b-25">Please Login</p>

           <!--<div class="row"> -->
           <form method="post" action="LogServlet" name="contact-form" class="contact-form">
        ...
        <div id="msgSubmit" class="h3 text-center hidden">Message Submitted!</div>
           ...
           <section class="col-md-12 content" id="admin">
       <div class="col-lg-6 col-md-6 col-md-push-6 content-item">
           <img src="images/4.jpg" alt="Image" class="tm-image">
       </div>
       <div class="col-lg-6 col-md-6 col-md-pull-6 content-item background flexbox">
           ...
           <!--<div class="row"> -->
           <form method="post" action="AdminServlet" name="contact-form" class="contact-form">
             <table align="center" cellpadding="10" cellspacing="10">
                 <tr>
                     <td>Admin ID</td>
...
<div class="text-center footer">
	<div class="container">
    	...
    	| Design: <a target="_parent" title="Puzzle Template"></a>
    </div>
</div>
