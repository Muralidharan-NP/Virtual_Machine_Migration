  ...
  <head>
    ...
    <link href="NewCss/css/animate.css" rel="stylesheet">
      ...
      <body id="top">
              ...
              <div class="row">
                <div class="col-md-8 col-md-offset-2 text-center inner">
                  <h1 class="animated fadeInDown">
                     Admin Page</h1>
                    <br />
               <h2 align="center">Cloud Request</h2>
               <br><br><br>
        ...
        ResultSet rss = stmt.executeQuery("select * from resource_request where Status='Waiting'");
        while(rss.next())
                       {
                   %>
                   <tr>
                       ...
                       <td><%=rss.getString("Cloud")%></td>
                       <td><%=rss.getString("Period")%></td>
                       <td><%=rss.getString("Status")%></td>
                       <td><a href="acc.jsp?a=<%=rss.getString("id")%>">Approve</a></td>
...
%>
  ...
  Statement smt = con.createStatement();
        ResultSet rss1 = smt.executeQuery("select * from resource_request where Status='Accepted'");
        while(rss1.next())
                       {
                   %>
                   <tr>
                       <td><%=rss1.getString("id")%></td>
                       <td><%=rss1.getString("User")%></td>
                       <td><%=rss1.getString("Name")%></td>
                       <td><%=rss1.getString("Mobile")%></td>
                       <td><%=rss1.getString("Email")%></td>
                       <td><%=rss1.getString("City")%></td>
                       <td><%=rss1.getString("Cloud")%></td>
                       <td><%=rss1.getString("Period")%></td>
                       <td><%=rss1.getString("Status")%></td>
