              ...
              <div class="row">
                <div class="col-md-8 col-md-offset-2 text-center inner">
                  <h1 class="animated fadeInDown">
                     Admin Page</h1>
                    <br />
               <a class="abcd" href="ViewReq.jsp">View All Request</a> 
               
                  <a class="abcd" href="UserList.jsp">Users List</a> 
                  
                  <a class="abcd" href="UsersCloud.jsp">Cloud Details</a> 
                  <a class="abcd" href="CreateVM.jsp">Virtual Machine</a> 
                  <br><br><br>
                  <a class="abcd" href="AllocateVM.jsp">Virtual Machine Allocation</a> 
                </div>
              </div>
              <div class="row">
